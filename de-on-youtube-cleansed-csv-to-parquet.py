{
	"jobConfig": {
		...
		"description": "",
		"role": "arn:aws:iam::232921993915:role/de-on-youtube-glue-s3-role",
		"command": "glueetl",
		"version": "3.0",
		"runtime": null,
		"workerType": "G.1X",
		...
		"scriptLocation": "s3://aws-glue-assets-232921993915-eu-west-3/scripts/",
		"language": "python-3",
		"jobParameters": [],
		"tags": [],
		"jobMode": "DEVELOPER_MODE",
		"createdOn": "2023-08-10T16:33:16.510Z",
		"developerMode": true,
		"connectionsList": [],
		"temporaryDirectory": "s3://aws-glue-assets-232921993915-eu-west-3/temporary/",
		"logging": true,
		...
		"sparkPath": "s3://aws-glue-assets-232921993915-eu-west-3/sparkHistoryLogs/",
		"flexExecution": false,
		"minFlexWorkers": null
	},
	"hasBeenSaved": false,
